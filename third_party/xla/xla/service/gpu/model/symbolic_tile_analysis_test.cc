...
fusion.1 {
  ...
  ROOT add.14443.1 = bf16[1,8,4096]{2,1,0} add(multiply.29309.3, bitcast.135978.1)
}

fusion.2 {
  parameter_0.1644 = bf16[1,8,4096]{2,1,0} parameter(0)
  multiply.28509 = bf16[1,8,4096]{2,1,0} multiply(parameter_0.1644, parameter_0.1644)
  ...
  ROOT multiply.28511 = bf16[1,8,4096]{2,1,0} multiply(parameter_0.1644, broadcast.70208)
}
...
ENTRY main {
  ...
  producer = bf16[1,8,4096]{2,1,0} fusion(param_0, param_1, param_2), kind=kCustom, calls=fusion.1
  consumer = bf16[1,8,4096]{2,1,0} fusion(producer), kind=kCustom, calls=fusion.2
  ROOT res = (bf16[1,8,4096]{2,1,0}, bf16[1,8,4096]{2,1,0}) tuple(producer, consumer)
})"));
